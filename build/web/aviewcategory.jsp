<%-- 
    Document   : aviewcategory
    Created on : Feb 20, 2017, 1:22:25 PM
    Author     : patels
--%>
...
<script src="js/owl.carousel.js"></script>
    ...
    <body>
       ...
       <div class="popular-w3">
            ...
            %>
            <div class="col-md-4 popular-grid" style=" width: 360px; height: 100px; float: left">
                        ...
                        <div class="popular-text">
                            ...
                            <div class="detail-bottom">
                                 <ul>
                                    <li class="text-info">Category id :</li>
                                    <li class="text-info1"><%=c.getCid()%></li>
                                    <div class="clearfix"></div>
                                </ul>
                                ...
                                <ul>
                                    <li class="text-info">Category Name :</li>
                                    <li class="text-info1"><%=c.getCname()%></li>
                                    <div class="clearfix"></div>
                                </ul>

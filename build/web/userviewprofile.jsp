<%-- 
    ...
    Created on : Mar 18, 2017, 12:55:38 PM
    Author     : patels
--%>
            ...
            <div class="container">
             ...
             <%
                ...
                if (request.getAttribute("al") != null) {
                    array = (ArrayList<Registration>) request.getAttribute("al");
                        ...
                        <div class="popular-text">
                            ...
                            <div class="detail-bottom">
                                ...
                                <ul>
                                 ...
                                 <ul>
                                    <li class="text-info">Edit :</li>
                                    <li><a href="editprofileserv?id=<%=r.getRid()%>"><input type="button" value="Edit"></a></li>
                                    <div class="clearfix"></div>
                                </ul>

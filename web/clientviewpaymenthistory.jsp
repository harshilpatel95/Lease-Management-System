<%-- 
    Document   : clientviewpaymenthistory
    Created on : Apr 12, 2017, 12:00:30 PM
    Author     : patels
--%>
            ...
            <div class="container">
             ...
             <%
                ...
                if (request.getAttribute("al") != null) {
                    array = (ArrayList<Buy>) request.getAttribute("al");
                    for(Buy b:array){
                        ...
                        <div class="popular-text">
                            ...
                            <div class="detail-bottom">
                                 <ul>
                                    ...
                                    <li class="text-info1"><%=b.getDate()%></li>
                                    <div class="clearfix"></div>
                                </ul>
                                ...
                                <ul>
                                    <li class="text-info">TxnId :</li>
                                    <li class="text-info1"><%=b.getTxnId()%></li>
                                    <div class="clearfix"></div>
                                </ul>
                                <ul>
                                    <li class="text-info">Amount :</li>
                                    <li class="text-info1"><%=b.getAmount()%></li>
                                    <div class="clearfix"></div>
                                </ul>

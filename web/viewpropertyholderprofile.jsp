<%-- 
    Document   : viewpropertyholderprofile
    Created on : Mar 21, 2017, 9:55:32 AM
    Author     : patels
--%>
                            ...
                            <div class="detail-bottom">
                                ...
                                <ul>
                                 ...
                                 <ul>
                                    ...
                                    <li><a href="editpropertyholderprofileserv?id=<%=r.getRid()%>"><input type="button" value="Edit"></a></li>
                                    <div class="clearfix"></div>
                                </ul>

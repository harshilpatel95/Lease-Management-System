    ...
    <body>
       <%@include file="Adminheader.jsp" %>
        <div class="popular-w3">
            ...
            %>
            <div class="col-md-4 popular-grid" style=" width: 380px; height: 850px; float: left">
                        <h4>
                            ...
                            <div class="detail-bottom">
                                ...
                                <ul>
                                 ...
                                 <ul>
                                   ...
                                   <li class="text-info1"><%=ap.getName()%></li>
                                    <div class="clearfix"></div>
                                </ul>
                                 ...
                                 <ul>
                                   ...
                                   <li class="text-info1"><%=ap.getContact()%></li>
                                    <div class="clearfix"></div>
                                </ul>
                                 <ul><%=ap.getStatus()%></ul>
                                 <ul><a href="acceptpropertyserv?id=<%=ap.getPid()%>"><input type="button" value="Accept"></a></ul>
                                 <ul><a href="rejectpropertyserv?id=<%=ap.getPid()%>"><input type="button" value="Reject"></a></ul>      
